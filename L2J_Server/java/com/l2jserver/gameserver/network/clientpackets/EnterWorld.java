...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		activeChar.sendMessage(getText("VGhpcyBTZXJ2ZXIgdXNlcyBMMkosIGEgUHJvamVjdCBmb3VuZGVkIGJ5IFplcnNpYQ=="));
		activeChar.sendMessage(getText("YW5kIGRldmVsb3BlZCBieSBaZXJzaWEgVGVhbSBhdCB3d3cuemVyc2lhLmNvbQ=="));
		activeChar.sendMessage(getText("Q29weXJpZ2h0IDIwMTMtMjAxNQ=="));
		activeChar.sendMessage(getText("VGhhbmsgeW91IGZvciAzIHllYXJzIQ=="));
